...
export const CarCard = ({
  ...
  return (
    <div className="row justify-content-start position-relative rounded-1 border border-gray bg-white p-4 mb-4 me-15rem ">
      <div className="col-3">
      ...
      <div className="col-7">
        ...
        <div className="row row-cols-lg-3">
          <RenderInfo label="Mileage" value={kilometer} icon={<MilageIcon />} />
          <RenderInfo
            label="Transmission"
            value={transmission}
